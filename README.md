# Significant DBSCAN
(This is the **Matlab** version. The **Python** implementation for data with arbitrary dimensions is now available at [Significant-DBSCAN-python](https://github.com/yqthanks/Significant-DBSCAN-python)!)
