function maxcomponent = lbdbscan(qgrid, minpts, neighborhood, maxthrd)

%maxthrd is the maximum number of points of a detected cluster (not bounded by upper bound), if exceeds, directly
%break
%same as ubdbscan code; separated to help reduce confusion
